...
import 'package:alif_pet/Client/client_request_detail.dart';
...
class ClientRequestsState extends State<ClientRequests> {
  bool isClient = true;
  bool isLoading = true;
                    ...
                    Container(
                      margin: CommonUtils.getLanguage(context) == "english"
                          ...
                          : EdgeInsets.only(
                              right: 2 * SizeConfig.widthMultiplier),
                      child: Text(
                        isClient ? request.doctor.name : request.client.name,
                        style: TextStyle(
                            fontFamily: FontUtils.ceraProBold,
